...
namespace WindowsFormsApp56
{
    ...
    public partial class Form1 : Form
    {
        ...
        public  string tanimlananid = "";
        public int yuzalgilama_sayac = 0;
        public int durdur = 0;
        public void yuzalgilavedevamet(string gelenid_yadaname)
        {
            if(durdur == 0)
            { 
            if (yuzalgilama_sayac == 3 && gelenid_yadaname == tanimlananid)
            {
                durdur = 1;
                //tanimlananid = "";
                yuzalgilama_sayac = 0;
                ...
                yuzalgilama_sayac++;
                //MessageBox.Show(yuzalgilama_sayac.ToString());
                tanimlananid = gelenid_yadaname;
